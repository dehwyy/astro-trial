...
export const posts = atom<IPost[]>([
  {
    ...
    theme: "code",
    content: "OK I Will def write content here \n but tbh it's kinda boring so this \n text won't be that long but it's not over!! It's so annoying please help me I don't really care japanese let's go!! このサイトは俺のアイデア ТЕПЕРь давайте на русском контраст создадим ",
    tags: ["anime", "japanese"]
  },
  {
    id: 2,
